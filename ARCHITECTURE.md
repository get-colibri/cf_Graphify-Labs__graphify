...
Each stage is a single function in its own module. Theysdd communicate through plain Python dicts and NetworkX graphs - no shared state, no side effects outside `graphify-out/`.
